...
**Quandary** — five questions a day, the same five for everyone.
Plan: `/Volumes/ExtremePro/Dev/next_mobile_apps/PLAN_2.md` (PLAN_2.md §4).
...
1. **Write the game.** Nothing of it exists yet — question bank, daily selection, scoring.
   The plan for this app is `next_mobile_apps/PLAN_2.md` (PLAN_2.md §4).
...
3. **Free tier**, as planned: archive last 7 days, category packs behind the unlock.
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.quandary` |
| Scheme | `quandary://` |
| GitHub | `AltixCode/quandary` |
| RevenueCat project | `proj431718f9` |
| RevenueCat iOS app | `app32b97c10e1` |
| RevenueCat Android app | `app7845aca696` |
| Entitlement | `remove_ads` (`entl07b903c1c4`) |
| Offering / package | `default` (`ofrng481a7a249e`) / `$rc_lifetime` (`pkge50eee8a93e`) |
| AdMob app (iOS) | `ca-app-pub-2504845459806550~4375770333` |
| AdMob app (Android) | `ca-app-pub-2504845459806550~7957501703` |
| AdMob banner (iOS / Android) | `ca-app-pub-2504845459806550/3651872298` / `ca-app-pub-2504845459806550/5783211615` |
| AdMob interstitial (iOS / Android) | `ca-app-pub-2504845459806550/8409374955` / `ca-app-pub-2504845459806550/9649857329` |
| AdMob rewarded (iOS / Android) | `ca-app-pub-2504845459806550/1962938993` / `ca-app-pub-2504845459806550/8336775654` |
| App Store app id | `6812275846` |
| App Store name | Quandary Daily Quiz |
| IAP id / product | `6812277323` / `com.altixcode.quandary.removeads` |

All ten release identifiers plus `EXPO_TOKEN` are already GitHub repo secrets.
Locally they come from `/Volumes/ExtremePro/Dev/mobile_expo_apps/.admob-ids/quandary.env` —
...
1. **App Store Connect record — done.** App `6812275846` exists, with
   ...
   is **Quandary Daily Quiz**, which may differ from the in-app name: App
...
- Shared code is generated. Fix it in `AltixCode/next-mobile-apps` (`_template/`)
  and re-run `node scripts/bootstrap.mjs quandary`, never in this copy —
