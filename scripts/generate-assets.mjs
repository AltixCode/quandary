#!/usr/bin/env node
/**
 * Generates every brand asset for Quandary from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"rect","x":0.08,"y":0.12,"w":0.84,"h":0.58,"r":0.17,"fill":"accent"},{"type":"poly","points":[[0.26,0.66],[0.46,0.66],[0.28,0.94]],"fill":"accent"},{"type":"circle","cx":0.3,"cy":0.41,"r":0.068,"fill":"ink"},{"type":"circle","cx":0.5,"cy":0.41,"r":0.068,"fill":"ink"},{"type":"circle","cx":0.7,"cy":0.41,"r":0.068,"fill":"ink"}];
 ...
 */
const MARK = [[0.45,1,1,1,0.45],[1,0.12,0.12,0.12,1],[0.12,0.12,0.45,1,0.45],[0.12,0.12,1,0.12,0.12],[0.12,0.12,1,0.12,0.12]];
...
console.log('Generating Quandary brand assets\n');
