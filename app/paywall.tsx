...
const BENEFITS = ["The full question archive","No ads, ever","Every category pack","Unlimited practice rounds and full stats"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">Quandary Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          Five questions a day. Everyone gets the same five.
        </Text>
