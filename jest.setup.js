...
// No test should ever reach a real server. content-drip's client (src/content/sync.ts)
// is written to fall back to the bundled question pool on any fetch failure, so a
// rejected fetch here both keeps tests offline and exercises that fallback path.
global.fetch = jest
  .fn()
